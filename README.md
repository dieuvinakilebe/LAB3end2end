...
https://github.com/dieuvinakilebe/LAB3end2end
#### Цель работы
...
```bash
E:\FastAPI-CRUD-Todo_test>pytest tests/test_e2e_todos_api.py -vv
======================== test session starts =========================
platform win32 -- Python 3.10.11, pytest-8.4.2, pluggy-1.6.0 -- C:\python.exe
cachedir: .pytest_cache
rootdir: E:\FastAPI-CRUD-Todo_test
plugins: anyio-4.10.0, cov-7.0.0
collected 2 items

tests/test_e2e_todos_api.py::test_e2e_create_read_update_delete_todo PASSED [ 50%]
tests/test_e2e_todos_api.py::test_e2e_validation_and_errors PASSED [100%]
